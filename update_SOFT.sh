...
#./xidel -e '(//@href, //@src)/resolve-uri(.)' https://github.com/FreeTubeApp/FreeTube/actions/workflows/build.yml | grep "FreeTube/actions/runs/" | grep -v "workflow" | head -n 1


#https://github.com/FreeTubeApp/FreeTube/actions/workflows/build.yml


#https://github.com/FreeTubeApp/FreeTube/actions/runs/5789409466

#https://github.com/FreeTubeApp/FreeTube/actions/runs/5789409466/job/15690402588

#./xidel -e '(//@href, //@src)/resolve-uri(.)' https://github.com/FreeTubeApp/FreeTube/actions/runs/5789409466 | grep "job" | head -n 1
...
#curl -H "Accept: application/vnd.github+json" -H "Authorization: token ${{ secrets.GITHUB_TOKEN }}" -L -o firmware.zip "https://github.com/FreeTubeApp/FreeTube/suites/14895239864/artifacts/848605744" 




#/FreeTubeApp/FreeTube/suites/14895239864/artifacts/848605747
...
#  curl -L -H "Accept: application/vnd.github+json" -H "Authorization: Bearer <YOUR-TOKEN>" -H "X-GitHub-Api-Version: 2022-11-28" https://api.github.com/repos/FreeTubeApp/FreeTube/actions/artifacts/848605747
...
echo XNVIEW: $url_p2
url_p3=$(./xidel -e '(//@href, //@src)/resolve-uri(.)' https://www.torproject.org/download/alpha/ | grep "\-linux\-x86_64\-" | sed '/\.asc/d')
echo TOR: $url_p3

url_p4=$(./xidel -e '(//@href, //@src)/resolve-uri(.)' https://github.com/FreeTubeApp/FreeTube/releases/ | grep "releases/tag" | head -n 1)
